...
<form id="theForm" action="phpequipmentreport.php" method="post" target="_self" onSubmit="mySubmit()" enctype="multipart/form-data">
...
<!-- header -->
      <div class="form-header-group ">
             ...
             <h1 style="text-align:Left;font-size:35px;font-weight:normal">Report a problem with equipments</h1>
            <h4 style="text-align:Left;font-size:25px;font-weight:normal" class="form-subHeader">
              To report a problem with equipments, please provide the following information below...
            </h4>
            <div>
              <div class="form-line">
...
<!-- Name -->
      ...
      <div class="form-line">
        ...
        <div id="cid_3" class=" ">
          <input type="text" name="Name"  size="30"  required="required" />
        </div>
      </div>
<!-- I am a -->
      <div class=" form-line">
    ...
    <!--  Phone Number-->
      ...
      <div class="form-line" data-type="" id="id_20">
        ...
        <div id="cid_20" class="form-input ">
          <input type="tel" name="phone"id="input_20"  data-type="input-number" class="  form-textbox " style="width:180px" size="20" value="" placeholder="ex: 0123456789" data-component="number" required="" pattern="^(\+?6?01)[0-46-9]-*[0-9]{7,8}$" />
        </div>
      </div>
<!--  Email-->
      <div class="form-line "  id="id_6">
        ...
        <div id="cid_6" class="form-input ">
          <input type="email"name="email" id="input_6" data-type="input-textbox" class="form-textbox" size="20" value="" placeholder=" " data-component="textbox" required="" />
        </div>
      </div>
      <!-- Equipment Details-->
      ...
      <div class="form-line " id="id_23">
        ...
        <div id="cid_23" class="form-input ">
          <select  name="equipmentName"id="input_23"  style="width:150px" data-component="dropdown" required="">
      ...
      <div class="form-line"  id="id_15">
        <label class="form-label " id="label_15" for="input_15"> Total Number of Equipments Borrowed </label>
        <div id="cid_15" class="form-input">
          <input type="number"name="equipmentNo" id="input_15"  data-type="input-number" class="  form-textbox " style="width:60px" size="5" value="" placeholder="ex: 23" data-component="number" />
        </div>
      </div>
      <!-- number of faulty Equipment-->
      <div class="form-line" id="id_16">
        <label class="form-label " id="label_16" for="input_16">
          Number of Faulty Equipments
          <span class="form-required">
            *
          </span>
        </label>
        <div id="cid_16" class="form-input ">
          <input type="number"name="equipmentfaultyNo" id="input_16"  data-type="input-number" class="  form-textbox" style="width:60px" size="5" value="" placeholder="ex: 23" data-component="number" required="" />
        </div>
      </div>
    ...
    <!-- Details of the problem observed -->
      <div class="form-line" id="id_11">
        <label class="form-label " id="label_11" for="input_11">
          Details of the problem observed (please provide as much information as possible).
          <span class="form-required">
            *
          </span>
        </label>
        <div id="cid_11" class="form-input ">
          <textarea id="input_11" name="problem"  class="form-textarea "  cols="70" rows="10" data-component="textarea" required=""></textarea>
        </div>
      </div>
<!-- file upload -->

      <div class="form-line" data-type="control_fileupload" id="id_17">
        <label class="form-label " id="label_17" for="input_17"> Please insert any photos of the equipment that you think may be or totally defected. </label>
        <span class="form-required">
          *
        </span>
        <div id="cid_17" class="form-input">
          <div data-wrapper-react="true">
            <div data-wrapper-react="true">
              ...
              <input  type="file" id="input_17" required="" name="image" multiple=""  data-imagevalidate="yes" data-file-accept="pdf, doc, docx, xls, csv, txt, rtf, html, zip, mp3, wma, mpg, flv, avi, jpg, jpeg, png, gif" data-file-maxsize="10240" data-file-minsize="0" data-file-limit="0" data-component="fileupload" />
            </div>
          </div>
        </div>
      </div>
