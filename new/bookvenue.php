...
<form id="theForm" action="phpbookvenue.php" method="post" target="_self" onSubmit="mySubmit()" enctype="multipart/form-data">
...
<!-- header -->
      <div class="form-header-group ">
             ...
             <h1 style="text-align:Left;font-size:35px;font-weight:normal">Book a Venue</h1>
            <h4 style="text-align:Left;font-size:25px;font-weight:normal" class="form-subHeader">
              To book venues, please provide the following information below...
            </h4>
            <div>
              <div class="form-line">
...
<!--  Email-->
      ...
      <div class="form-line " id="id_23">
        ...
        <div id="cid_23" class="form-input ">
          <select  name="venueName"id="input_23"  style="width:150px" data-component="dropdown" required="">
