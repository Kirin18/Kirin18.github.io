...
<form id="theForm" action="phpvenuereport.php" method="post" target="_self" onSubmit="mySubmit()" enctype="multipart/form-data">
...
<!-- header -->
      <div class="form-header-group ">
             ...
             <h1 style="text-align:Left;font-size:35px;font-weight:normal">Report a problem with Venue</h1>
            <h4 style="text-align:Left;font-size:25px;font-weight:normal" class="form-subHeader">
              To report a problem with Venue, please provide the following information below...
            </h4>
            <div>
              <div class="form-line">
...
<!-- Name -->
      ...
      <div class="form-line">
        ...
        <div id="cid_3" class=" ">
          <input type="text" name="Name"  data-type="input-textbox" class="form-textbox " size="30" value="" placeholder=" " data-component="textbox" required="required" />
        </div>
      </div>
<!-- I am a -->
      <div class=" form-line">
...
<!--  Email-->
      ...
      <div class="form-line" data-type="control_text" id="id_13">
        <div id="cid_13" class="form-input-wide">
          ...
          <hr width="100%">
            <h3 style="text-align:Left;font-size:25px;font-weight:normal">Venue Details</h3>
          </div>
        </div>
      </div>
      <!-- Type of Equipment-->
      <div class="form-line " id="id_23">
        ...
        <div id="cid_23" class="form-input ">
          <select  id="input_23" name="venueName" style="width:150px" data-component="dropdown" required="">
            <option value="Banquet Hall, ICC"> Banquet Hall, ICC </option>
            <option value="ICC Hall"> ICC Hall </option>
            <option value="Main Auditorium"> Main Auditorium </option>
            <option value="Multipurpose Hall Wadi Budi"> Multipurpose Hall Wadi Budi </option>
            <option value="SHAHS Mosque"> SHAHS Mosque </option>
          </select>
        </div>
      </div>
    ...
    <!-- Details of the problem observed -->
      <div class="form-line" id="id_11">
        ...
        <div id="cid_11" class="form-input ">
          <textarea id="input_11" class="form-textarea " name="problem" cols="70" rows="10" data-component="textarea" required=""></textarea>
        </div>
      </div>
<!-- file upload -->

      <div class="form-line" data-type="control_fileupload" id="id_17">
        <label class="form-label " id="label_17" for="input_17"> Please insert any photos of the problems you've noticed in the venue </label>
        <span class="form-required">
          *
        </span>
